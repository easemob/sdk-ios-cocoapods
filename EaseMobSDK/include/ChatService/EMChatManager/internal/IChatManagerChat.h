...
- (EMMessage *)forwardMessage:(EMMessage *)message
                      ...
                      isGroup:(BOOL)isGroup
                     progress:(id<IEMChatProgressDelegate>)progress
                        error:(EMError **)pError EM_DEPRECATED_IOS(2_0_0, 2_0_9, "请使用带 ext 的方法");
...
- (EMMessage *)asyncForwardMessage:(EMMessage *)message
                                to:(NSString *)username
                           isGroup:(BOOL)isGroup
                          progress:(id<IEMChatProgressDelegate>)progress EM_DEPRECATED_IOS(2_0_0, 2_0_9, "请使用带 ext 的方法");
...
- (EMMessage *)asyncForwardMessage:(EMMessage *)message
                        ...
                        completion:(void (^)(EMMessage *message,
                                             EMError *error))completion
                           onQueue:(dispatch_queue_t)aCompletionQueue EM_DEPRECATED_IOS(2_0_0, 2_0_9, "请使用带 ext 的方法");
